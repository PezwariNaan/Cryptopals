...
namespace openssl {
    ...
    std::vector<uint8_t> encrypt_cbc(EVP_CIPHER_CTX *ctx, const int blocksize, const std::vector<uint8_t> plaintext, const std::vector<uint8_t> iv, const std::vector<uint8_t> &key);
}
